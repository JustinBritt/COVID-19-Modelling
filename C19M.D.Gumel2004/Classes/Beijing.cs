namespace C19M.D.Gumel2004.Classes
{
    ...
    public sealed class Beijing : IBeijing
    {
        ...
        /// Gets the start date.
        /// </summary>
        public FhirDateTime StartDate => new FhirDateTime(new DateTimeOffset(new DateTime(2003, 2, 15)));
        ...
        /// Units: Per day
        /// </summary>
        public FhirDecimal DiseaseInducedDeathRateSymptomaticIndividuals => new FhirDecimal(0.0055m);
        ...
        /// Units: Per day
        /// </summary>
        public FhirDecimal DiseaseInducedDeathRateIsolatedIndividuals => new FhirDecimal(0.0041m);

        /// <summary>
        /// Gets the initial value for asymptomatic individuals.
        /// Parameter: E(0)
        /// </summary>
        public FhirDecimal InitialValueAsymptomaticIndividuals => new FhirDecimal(10m);

        /// <summary>
        /// Gets the initial value for symptomatic individuals.
        /// Parameter: I(0)
        /// </summary>
        public FhirDecimal InitialValueSymptomaticIndividuals => new FhirDecimal(3m);
        ...
        /// Parameter: S(0)
        /// </summary>
        public FhirDecimal InitialValueSusceptibleIndividuals => new FhirDecimal(12000000m);

        /// <summary>
        /// Gets the basic transmission coefficient.
        /// Parameter: β
        /// </summary>
        public FhirDecimal BasicTransmissionCoefficient => new FhirDecimal(0.23m);
        ...
        /// Units: Per day
        /// </summary>
        public FhirDecimal NetInflowRateSusceptibleIndividuals => new FhirDecimal(408m);
        ...
        /// Units: Per day
        /// </summary>
        public FhirDecimal RecoveryRateSymptomaticIndividuals => new FhirDecimal(0.0413m);
        ...
        /// Units: Per day
        /// </summary>
        public FhirDecimal RecoveryRateIsolatedIndividuals => new FhirDecimal(0.0431m);
    }
}