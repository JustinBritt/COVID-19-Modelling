namespace C19M.UI.Models.Gumel2004
{
    ...
    public sealed class BeijingModel
    {
        // Constructor
        public BeijingModel()
        {
        ...
        // TODO: Update
        public string[] Days => this.Import.DayCumulativeDiseaseInducedDeaths.Select(w => w.Item1.ToDateTimeOffset(TimeSpan.Zero).UtcDateTime.Date.ToString("s").Replace(".", string.Empty)).ToArray();
