namespace C19M.M.C.A.Gumel2006.Classes.Calculations.DayCumulativeProbableCases
{
    ...
    internal sealed class DayCumulativeProbableCases_Calculation : IDayCumulativeProbableCases_Calculation
    {
        ...
        {
            return new C19M.M.C.A.Gumel2006.Classes.Results.DayCumulativeProbableCases.DayCumulativeProbableCases(
                t.Value.Select(
                    w => new C19M.M.C.A.Gumel2006.Classes.Calculations.DayCumulativeProbableCases.DayCumulativeProbableCases_ResultElement_Calculation().Calculate(
                        w,
                        t,
                        dayProbableCases))
                .ToImmutableList());
