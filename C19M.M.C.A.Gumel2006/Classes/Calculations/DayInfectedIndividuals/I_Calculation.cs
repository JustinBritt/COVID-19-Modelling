namespace C19M.M.C.A.Gumel2006.Classes.Calculations.DayInfectedIndividuals
{
    ...
    internal sealed class I_Calculation : II_Calculation
    {
        ...
        {
            return new C19M.M.C.A.Gumel2006.Classes.Results.DayInfectedIndividuals.I(
                t.Value.Select(
                    w => new C19M.M.C.A.Gumel2006.Classes.Calculations.DayInfectedIndividuals.I_ResultElement_Calculation().Calculate(
                        w,
                        t,
                        RungeKuttaResults))
                .ToImmutableList());
